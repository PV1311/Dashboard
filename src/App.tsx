      ...
      <div className="min-h-screen relative">
        ...
        <div className={`fixed top-16 bottom-0 w-64 bg-white shadow-lg z-50 transition-transform duration-300 lg:translate-x-0 ${
          ...
          <div className="p-4 space-y-2">
            ...
            <button
              onClick={() => {
                window.location.href = 'https://demosmartboard.netlify.app/bins';
              }}
        ...
        <main className="lg:ml-64 pt-16">
          <Routes>
            ...
            />
            <Route path="/routes" element={<div>Route Optimization Page</div>} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-8 pb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-lg text-center font-semibold mb-2">Total Bins</h3>
              <p className="text-3xl text-center font-bold text-green-600">{totalBins}</p>
              <p className="text-sm text-center text-gray-500 mt-2">Across {bins.length ? bins[0].location.area : 'all'} areas</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-lg text-center font-semibold mb-2">Critical Bins</h3>
              <p className="text-3xl text-center font-bold text-red-600">{criticalBins}</p>
              <p className="text-sm text-center text-gray-500 mt-2">Requiring immediate attention</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-lg text-center font-semibold mb-2">Active Routes</h3>
              <p className="text-3xl text-center font-bold text-blue-600">{activeRoutes}</p>
              <p className="text-sm text-center text-gray-500 mt-2">Currently being serviced</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-lg text-center font-semibold mb-2">Bins Collected Today</h3>
              <p className="text-3xl text-center font-bold text-purple-600">{binsCollectedToday}</p>
              <p className="text-sm text-center text-gray-500 mt-2">Updated hourly</p>
            </div>
          </div>
        </main>
      </div>
