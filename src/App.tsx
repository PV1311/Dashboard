...
import { Box, LayoutDashboard, TrendingUp, Route, BarChart, Menu, X } from 'lucide-react';
      ...
      <main className="lg:ml-64 pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-8 pb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-sm text-gray-500 mt-2">Across {bins.length ? bins[0].location.area : '5'} areas</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-sm text-gray-500 mt-2">Currently being serviced</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold mb-2">Bins Collected Today</h3>
            <p className="text-3xl font-bold text-purple-600">{binsCollectedToday}</p>
